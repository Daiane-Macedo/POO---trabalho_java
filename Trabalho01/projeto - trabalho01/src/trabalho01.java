...
public class trabalho01{
    ...
    //Lê um novo nome adiciona ao fim do vetor (o método não funciona come nome e sobrenome)
    public static void Ler_nome(ArrayList<String> lista) {
    	...
    	//Verifica se o nome é composto apenas por espaços
    ...
    public static void main(String[] args){
		...
		do {
		    ...
		    System.out.println("    3 - Gravar a lista de nomes de pessoas");
